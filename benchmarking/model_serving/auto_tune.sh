...
BASE="${PROJECT_DIR}/model_serving/tuning"

# ["DeepSeek-V2-Lite-Chat/snapshots/85864749cd611b4353ce1decdb286193298f64c7", "Qwen3-14B", "Qwen3-1.7B"]

model_folder_name="DeepSeek-V2-Lite-Chat/snapshots/85864749cd611b4353ce1decdb286193298f64c7"
model_folder_name="Qwen3-14B"
MODEL="${PROJECT_DIR}/model_weights/${model_folder_name}"
...
NUM_SEQS_LIST="128 256 512 1024"
...
BENCHMARK_SERVING_PY="$PROJECT_DIR/vllm/benchmarks/benchmark_serving.py"
